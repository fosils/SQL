...
begin
	...
	select worker_initials into _task_giver from task_manager.freelancers where email = gui.get_current_user();
	...
	VALUES
		(
			...
			TRUE, cell_table, cell_column, cell_id, from_date, until_date, (select id from column_task_description where column_name = cell_column),
			_task_giver
			);
